        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <form action="{{ route('admin.user.store') }}" method="POST" class="p-6">
                ...
                <div class="mt-8 p-4 bg-blue-50 rounded-lg">
                    <h3 class="text-sm font-medium text-blue-900 mb-2">Additional Information</h3>
                    <ul class="text-sm text-blue-700 space-y-1">
                        <li>• User will be created with "user" role</li>
                        <li>• Email will be automatically verified</li>
                        <li>• User will receive account credentials via email</li>
                ...
                <div class="mt-8 flex items-center justify-end space-x-4">
                    ...
                    <button type="submit" 
                            class="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-md font-medium flex items-center">
